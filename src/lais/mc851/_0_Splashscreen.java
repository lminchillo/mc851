	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		new AsyncTask<Void, Void, Void>()
		{
			...
			protected Void doInBackground(Void... params)
			{
				...
				List<String> aux = GPSManager.getLocation("Rua Alcides Soares Cunha, 240", getApplicationContext());
				String address1 = aux.get(0);
				String address1latlng = aux.get(1);
				aux = GPSManager.getLocation("Rua Doutor Lauro Pimentel, 433", getApplicationContext());
				String address2 = aux.get(0);
				String address2latlng = aux.get(1);
				String route = "Casa/Trabalho" +
						"\n"+address1 +
						"\n"+address1latlng +
						"\n"+address2 +
						"\n"+address2latlng;
